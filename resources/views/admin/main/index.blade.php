...
@section('content')
    ...
    <div class="container">
        ...
        <form class="m-15" method="POST" action="{{route('admin.form')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="1" id="slider" name="slider" {{ $config->slider ? 'checked' : '' }}>
