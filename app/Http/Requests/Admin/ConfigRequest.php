...
class ConfigRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'txt_1' => 'nullable|string|max:1000',
            'txt_2' => 'nullable|string|max:1000',
            'txt_3' => 'nullable|string|max:1000',
            'txt_4' => 'nullable|string|max:1000',
            ...
            'logo' => 'nullable|mimes:png,jpg,jpeg,webp,csv,txt,xlx,xls,pdf,doc,docx,webp|max:2048',
